...
public class DebugDatabaseFragment extends FragmentBase {
    ...
    public Class<? extends FragmentConfiguration> getFragmentConfigurationClass() {
        return DebugDatabaseFragmentConfiguration.class;
    }
    ...
    public static class DebugDatabaseFragmentConfiguration extends FragmentConfiguration {
        public DebugDatabaseFragmentConfiguration(Context context) {
            super(context);
        }
        ...
        public Class<? extends FeatureConfiguration> getFeatureConfigurationClass() {
            return DebugDatabaseConfiguration.class;
        }
