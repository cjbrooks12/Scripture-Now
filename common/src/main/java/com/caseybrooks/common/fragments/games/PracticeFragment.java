package com.caseybrooks.common.fragments.games;
...
//--------------------------------------------------------------------------------------------------
    public void initializeSettingsDialog() {
        ...
        builder.setNegativeButton("Close", new Util.CancelDialogAction());
...
//--------------------------------------------------------------------------------------------------
    ...
    private class ChoiceViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChoiceViewHolder(View itemView) {
            super(itemView);
            text = (TextView) itemView.findViewById(R.id.pill);
        }
