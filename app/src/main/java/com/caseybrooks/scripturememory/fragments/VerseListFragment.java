...
//------------------------------------------------------------------------------
	public class BibleVerseAdapter extends ArrayAdapter<Passage> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TextView icon_text = (TextView) itemView.findViewById(R.id.ref_icon);
            ...
            final ImageView icon_background = (ImageView) itemView.findViewById(R.id.ref_icon_circle);
            ...
            icon_background.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final Animation c = AnimationUtils.loadAnimation(context, R.anim.full_rotate_ccw);
	...
	public void onListItemClick(ListView lv, View v, int position, long id) {
		...
		switchToEditFragment((int)currentVerse.getId());
	}
